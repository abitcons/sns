    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <Link
            to="/services"
            className="relative inline-flex items-center px-10 py-4 bg-white text-primary font-bold rounded-lg shadow-lg text-lg transition-all duration-300 hover:bg-primary hover:text-white hover:shadow-xl"
          >
            <span className="z-10">{t('cta_services.button')}</span>
            <div
              className="absolute inset-0 bg-gradient-to-r from-[#36a0d0] via-[#5bb6bb] to-[#6ec6ab] opacity-0 rounded-lg group-hover:opacity-100 transition-opacity duration-300"
              style={{
