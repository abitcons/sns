...
const AlphaiotaSection = () => {
  ...
  const features = Array.isArray(t("alphaiota.features", { returnObjects: true }))
    ? (t("alphaiota.features", { returnObjects: true }) as Array<{ title: string; description: string }>)
    : [];
  ...
  return (
    <section id="AlphaiotaSection" className="py-24 bg-gradient-to-br from-blue-50 via-white to-blue-50">
