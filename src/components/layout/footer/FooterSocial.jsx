...
function ThreadsIcon({ className }) {
    return (<svg viewBox="0 0 192 192" className={className} fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
export default function FooterSocial() {
    ...
    return (<div>
      ...
      <div className="flex flex-wrap gap-4">
        {socialLinks.map((social) => (<motion.a key={social.name} href={social.href} target="_blank" rel="noopener noreferrer" className={`text-white/90 transition-colors ${social.hoverColor}`} whileHover={{ scale: 1.2 }} whileTap={{ scale: 0.9 }} title={t(`footer.social.platforms.${social.name}`)}>
