export default function SNSLogo({ className = '', variant = 'default' }) {
    ...
    return (<svg viewBox="0 0 163 83.8" className={className} preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
      <defs>
