    ...
    return (<article className="min-h-screen bg-white">
      ...
      <div className="relative bg-gradient-to-b from-gray-50 to-white pt-20 pb-16">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-3xl mx-auto">
            {/* Back Button */}
            <Link to="/blog" className="inline-flex items-center text-[#36a0d0] hover:text-[#2b80a5] mb-8 group">
            ...
            <div className="relative">
              ...
              <motion.div initial={{ width: "0%" }} animate={{ width: "100%" }} transition={{ duration: 0.6, ease: "easeOut" }} className="absolute -left-4 top-1/2 h-1 bg-[#36a0d0]/10 transform -translate-y-1/2 -z-10"/>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="max-w-3xl mx-auto">
          ...
          <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="relative rounded-2xl overflow-hidden mb-16 shadow-xl group">
