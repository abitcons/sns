  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta
          name="description"
          content="Streamline resident management with SNAM Muqeem. Automate documentation, ensure compliance, and seamlessly integrate with SAP SuccessFactors for efficient resident administration in Saudi Arabia."
        />
        <meta
          name="keywords"
          content="SNAM Muqeem, resident management Saudi Arabia, SAP integration, Iqama management, Saudi resident documentation, compliance automation"
        />
        ...
        <meta
          ...
          content="Transform resident management with automated documentation, real-time compliance monitoring, and seamless SAP integration."
        />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="relative z-10 rounded-2xl overflow-hidden shadow-2xl">
                <img 
                  src="/images/SNAM-Muqeem-Interface.png"
                  alt="SNAM Muqeem Interface"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <button
              ...
              onClick={() => window.location.href = 'https://store.sap.com/dcp/en/product/display-2002001293_live_v1/snam-muqeem'}
            >
              Visit SAP Store
            </button>
            <button
