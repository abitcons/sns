  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta
          name="description"
          content="Transform your business with SAP S/4HANA® – the intelligent ERP solution tailored for industries in Saudi Arabia. Explore seamless implementation, real-time analytics, and innovative features with Smart National Solutions."
        />
        <meta
          name="keywords"
          content="SAP S/4HANA Saudi Arabia, ERP Implementation, SAP ERP, Industries ERP Solutions, Digital Transformation, SAP Fiori®, Real-Time Analytics, Middle East SAP Solutions"
        />
...
<section className="py-20 bg-white">
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center gap-12">
    ...
    <div className="lg:w-1/2">
      ...
      >
        <img
          src="/images/sap-s4hana.png"
          alt="Why Migrate to SAP S/4HANA"
