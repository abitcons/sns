  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta
          name="description"
          content="Discover SAP Analytics Cloud, the ultimate solution for data visualization, planning, and predictive analytics, tailored for businesses in Saudi Arabia and the Middle East."
        />
        <meta
          name="keywords"
          content="SAP Analytics Cloud, Data Visualization, Predictive Analytics, Saudi Arabia, Middle East, SAP Solutions"
        />
        ...
        <meta
          ...
          content="SAP Analytics Cloud empowers businesses in Saudi Arabia and the Middle East to make data-driven decisions with powerful analytics and predictive insights."
        />
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <motion.img
              src="/images/sap-analytics-cloud-dashboard.jpg"
      ...
      <section className="py-20 text-center">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <a
            href="https://www.sap.com/products/analytics-cloud.html"
            target="_blank"
