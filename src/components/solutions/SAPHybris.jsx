...
export default function SAPHybris() {
    return (<>
      ...
      <Helmet>
        ...
        <meta name="description" content="Explore SAP Hybris, a cutting-edge solution for omnichannel commerce, marketing, and customer engagement, tailored to meet the demands of businesses in Saudi Arabia and the Middle East."/>
        <meta name="keywords" content="SAP Hybris, Customer Engagement, Omnichannel Commerce, Saudi Arabia, Middle East, SAP Solutions"/>
        ...
        <meta property="og:description" content="SAP Hybris offers businesses in Saudi Arabia and the Middle East the tools to enhance customer experiences and drive sales through innovative technology."/>
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
      ...
      <motion.img src="/images/sap-hybris-dashboard.png" alt="SAP® Hybris® Dashboard" initial={{ opacity: 0, x: 50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }} className="rounded-lg shadow-lg"/>
    </div>
  </div>
    </section>
      ...
      {[
            {
                ...
                description: "Work with an award-winning SAP® partner offering certified consultants and a proven track record in implementing SAP® Hybris® solutions.",
            },
            {
                title: 'Customized Solutions',
                description: "Get tailored SAP® Hybris® implementations to meet your unique business requirements, ensuring maximum ROI and scalability.",
            },
            {
                title: 'Comprehensive Support',
                description: "Experience unmatched post-implementation support from SNS, ensuring optimal performance and continuous innovation.",
            },
            {
                title: 'Local Market Insights',
                description: "Leverage SNS’s deep understanding of the Saudi Arabian and Middle Eastern markets to deliver localized solutions with SAP® Hybris®.",
            },
            {
                title: 'Seamless Integration',
                description: "Benefit from SNS’s expertise in integrating SAP® Hybris® with other SAP® solutions for a unified, efficient digital ecosystem.",
            },
            {
                title: 'Proven Results',
                description: "Join leading enterprises that have transformed their commerce operations with SAP® Hybris® and SNS’s strategic approach.",
            },
        ].map((benefit, index) => (<motion.div key={index} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: index * 0.2 }} className="relative bg-gradient-to-r from-[#36a0d0]/10 to-[#5bb6bb]/10 p-8 rounded-lg shadow-lg text-left transform hover:scale-105 hover:shadow-xl transition-all duration-300">
      ...
      {[
            {
                ...
                description: "Unify customer experiences across digital and physical touchpoints with SAP®'s integrated commerce platform, ensuring consistent and personalized interactions.",
            },
            {
                title: 'Real-Time Analytics',
                description: "Make data-driven decisions with SAP®'s powerful analytics engine, delivering actionable insights for precise marketing campaigns and optimized sales strategies.",
            },
            {
                title: 'Scalable Solutions',
                description: "Expand confidently with SAP®'s enterprise-grade platform, designed to handle growing transaction volumes while maintaining superior performance.",
            },
        ].map((benefit, index) => (<motion.div key={index} initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ duration: 0.8, delay: index * 0.2 }} className="bg-white p-8 rounded-xl shadow-lg text-center transform hover:scale-105 hover:shadow-2xl transition-all duration-300">
