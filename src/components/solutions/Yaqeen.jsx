...
import { CheckCircle, ArrowRight, Shield, Database, FileText, Bell, BarChart2, Languages, UserCheck, Link } from 'lucide-react';
export default function SNAMYaqeen() {
    return (<>
      {/* SEO Meta Tags */}
      <Helmet>
        <title>SNAM Yaqeen - Advanced Employee Verification Solution</title>
        <meta name="description" content="Transform your HR operations with SNAM Yaqeen. Automate employee verification, ensure compliance, and integrate seamlessly with SNAM Muqeem for comprehensive workforce management."/>
        <meta name="keywords" content="SNAM Yaqeen, employee verification, HR compliance, data validation, SAP integration, secure employee management, Muqeem integration"/>
        ...
        <meta property="og:description" content="Transform HR operations with automated verification, real-time compliance monitoring, and seamless SAP integration."/>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="relative">
              <div className="relative z-10 rounded-2xl overflow-hidden shadow-2xl">
                <img src="/images/SNAM-Yaqeen-Interface.png" alt="SNAM Yaqeen Interface" className="w-full h-full object-cover"/>
              </div>
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
      ...
      <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="space-y-8">
        ...
        ].map((item, index) => (<motion.div key={index} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: index * 0.2 }} className="flex gap-4">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mt-8 p-6 rounded-xl bg-gradient-to-r from-[#36a0d0]/5 to-[#6ec6ab]/5 border border-gray-100">
          ...
          <div className="space-y-4 text-gray-600">
            ...
            <div className="mt-6">
              <a href="https://www.sap.com/mena/partners/find/qualified-packaged-solutions/finder/smart-national-solutions-for-information-successfactors-snam-solutions-integration.html" target="_blank" rel="noopener noreferrer" className="inline-flex items-center px-6 py-3 bg-[#36a0d0] text-white rounded-lg hover:bg-[#5bb6bb] transition-all duration-300 group">
      ...
      <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="relative">
        <div className="relative z-10 rounded-2xl overflow-hidden shadow-2xl bg-white p-8">
          <div className="flex flex-col items-center space-y-8">
            {/* Yaqeen System */}
            <motion.div initial={{ scale: 0.9, opacity: 0 }} whileInView={{ scale: 1, opacity: 1 }} transition={{ duration: 0.5 }} className="w-full">
              <div className="p-6 rounded-xl bg-gradient-to-br from-[#36a0d0]/10 to-transparent border border-[#36a0d0]/20 group hover:bg-[#36a0d0]/5 transition-all duration-300">
                <div className="flex items-center justify-center">
                  <img src="/SNAM-Logos/SNAM-yaqeen.svg" alt="SNAM Yaqeen" className="h-16 w-auto transform transition-transform duration-300 group-hover:scale-105"/>
                </div>
            ...
            <motion.div initial={{ scale: 0.5, opacity: 0 }} whileInView={{ scale: 1, opacity: 1 }} transition={{ duration: 0.5, delay: 0.3 }} className="relative w-full h-20 flex justify-center items-center">
              {/* Connection line */}
            ...
            {/* Muqeem System */}
            <motion.div initial={{ scale: 0.9, opacity: 0 }} whileInView={{ scale: 1, opacity: 1 }} transition={{ duration: 0.5, delay: 0.6 }} className="w-full">
              <div className="p-6 rounded-xl bg-gradient-to-br from-[#6ec6ab]/10 to-transparent border border-[#6ec6ab]/20 group hover:bg-[#6ec6ab]/5 transition-all duration-300">
                <div className="flex items-center justify-center">
                  <img src="/SNAM-Logos/SNAM-muqeem.svg" alt="SNAM Muqeem" className="h-16 w-auto transform transition-transform duration-300 group-hover:scale-105"/>
                </div>
                <div className="text-center mt-3">
            ...
            {/* Integration Status */}
            <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 1, delay: 0.9 }} className="w-full py-3 px-4 rounded-lg bg-gradient-to-r from-[#36a0d0]/5 to-[#6ec6ab]/5 border border-gray-100">
      ...
      <section className="py-20 bg-gray-50 text-center">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.div className="flex justify-center gap-4" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <button className="px-8 py-3 bg-[#36a0d0] text-white rounded-lg font-semibold hover:bg-opacity-90 transition-colors duration-300" onClick={() => window.location.href = 'https://store.sap.com/dcp/en/product/display-2002001834_live_v1/snam-yaqeen'}>
              Visit SAP Store
            </button>
