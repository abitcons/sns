...
import { RefreshCw, Link as LinkIcon, LineChart, Shield, Smartphone, CreditCard, } from 'lucide-react';
export default function SNAMTravel() {
    return (<>
      {/* SEO Meta Tags */}
      <Helmet>
        <title>SNAM Travel - Revolutionizing Corporate Travel Management</title>
        <meta name="description" content="Streamline corporate travel management with SNAM Travel. Automate approvals, control expenses, and seamlessly integrate with SAP for an efficient travel management solution."/>
        <meta name="keywords" content="SNAM Travel, corporate travel management, SAP integration, expense tracking, business travel automation, travel management solutions"/>
        ...
        <meta property="og:description" content="Discover SNAM Travel: Automate travel requests, manage expenses in real-time, and optimize costs with SAP integration."/>
   ...
   <section className="py-24 bg-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="space-y-8">
              ...
              <motion.div initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="flex items-center space-x-3 bg-gradient-to-r from-[#36a0d0]/10 to-[#6ec6ab]/10 p-4 rounded-xl border border-[#5bb6bb]/20">
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="relative">
              <div className="relative z-10 rounded-2xl overflow-hidden shadow-2xl">
                <div className="group relative aspect-w-16 aspect-h-9 bg-gray-100 rounded-lg overflow-hidden transition-all duration-300 hover:shadow-xl hover:scale-[1.02]">
                  <img src="/images/snam-travel-dashboard.png" alt="SNAM Travel Dashboard" className="w-full h-full object-cover transition-transform duration-300 group-hover:scale-105"/>
    ...
    <section className="py-32 bg-gray-50 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mt-16 bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
            ...
            "Reporting & analytics"
        ].map((item, index) => (<motion.div key={index} initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ delay: index * 0.1 }} className="flex items-center space-x-3 p-4 rounded-lg hover:bg-gray-50 transition-colors duration-300">
    ...
    <section className="py-32 bg-white relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-0 right-0 w-1/2 h-full">
          <svg className="h-full w-full" viewBox="0 0 100 100" preserveAspectRatio="none">
            <path d="M0 0 L50 100 L100 0 V100 H0" fill="url(#analytics-gradient)" fillOpacity="0.05"/>
            <defs>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            ...
            },
            {
        ...
        ].map((analytics, index) => (<motion.div key={index} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: index * 0.2 }} className="group relative">
              {/* Card */}
              <div className="h-full bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-100">
                ...
                <ul className="space-y-3 mb-8">
                  {analytics.features.map((feature, idx) => (<li key={idx} className="flex items-center text-gray-600">
        ...
        ].map((metric, index) => (<motion.div key={index} initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ delay: index * 0.1 }} whileHover={{ scale: 1.05 }} className="bg-gradient-to-r from-[#36a0d0]/5 to-[#6ec6ab]/5 rounded-xl p-6 text-center hover:from-[#36a0d0]/10 hover:to-[#6ec6ab]/10 transition-colors duration-300">
     ...
     <section className="py-20 bg-gray-50 text-center">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <button className="px-8 py-3 bg-[#36a0d0] text-white rounded-lg font-semibold hover:bg-opacity-90" onClick={() => window.location.href = 'https://store.sap.com/dcp/en/product/display-2001016814_live_v1/snam-travel'}>
            Visit SAP Store
          </button>
        </div>
      </section>
