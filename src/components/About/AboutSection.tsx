...
const AboutSection = () => {
  return (
    <section className="py-12 bg-gradient-to-r from-gray-100 via-white to-gray-50">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 items-center px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="pt-4 flex items-center">
            <Link
              to="/contact"
              className="inline-flex items-center bg-primary text-white font-semibold text-xl px-6 py-3 rounded-lg hover:bg-primary/90 transition-all duration-300"
            >
