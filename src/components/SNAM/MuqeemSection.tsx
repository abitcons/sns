    ...
    <section className="relative py-20 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="text-white space-y-8">
              ...
              return (
                ...
                >
                  <div className="flex items-start gap-4">
                    <motion.div
                      className="p-2 rounded-lg bg-white/20 mt-1"
                      animate={hoveredIndex === index ? feature.animation.icon : {}}
                      transition={{ duration: feature.animation.duration, repeat: Infinity }}
                    >
          ...
          >
            <motion.a
              href="https://store.sap.com/dcp/en/product/display-2002001293_live_v1/snam-muqeem"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center px-8 py-4 bg-white text-[#36a0d0] font-semibold text-xl rounded-lg hover:bg-gray-50 transition-all duration-300 shadow-lg"
        ...
        >
          ...
          <div className="relative rounded-xl overflow-hidden shadow-2xl bg-white/10 p-1">
            ...
            >
              <img
                src="/images/SNAM-Muqeem-QPP.png"
                alt="SNAM Muqeem Dashboard"
