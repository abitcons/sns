            ...
            <div className="flex-1">
              ...
              >
                ...
                <motion.a
                  ...
                  className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-[#36a0d0] via-[#5bb6bb] to-[#6ec6ab] text-white rounded-lg font-medium group hover:shadow-lg transition-shadow"
            ...
            >
              <div className="relative w-48 h-48 md:w-64 md:h-64">
                ...
                <img
                  ...
                  alt="SAP Qualified Partner Badge"
