...
// Modified ScrollToTop component with loading state
        ...
        <div className="hidden lg:flex lg:items-center lg:gap-x-4 lg:mr-4" role="group" aria-label="Language Switcher">
            <button 
                ...
                className={`px-4 py-2 rounded-lg font-medium transition-all duration-300 ${
                    i18n.language === 'en' ? 'bg-primary text-white' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'
                }`}
            ...
            <button 
                ...
                className={`px-4 py-2 rounded-lg font-medium transition-all duration-300 ${
                    i18n.language === 'ar' ? 'bg-primary text-white' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'
                }`}
