...
export default function Contact() {
    ...
    return (<>
      <Helmet>
        ...
        <meta name="description" content="Get in touch with Smart National Solutions. We're here to help you with your digital transformation journey."/>
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="text-center max-w-3xl mx-auto">
            <div className="inline-block mb-6">
              <motion.div initial={{ scale: 0 }} animate={{ scale: 1 }} transition={{ duration: 0.5 }} className="bg-white/50 backdrop-blur-sm px-6 py-2 rounded-full border border-[#36a0d0]/20 shadow-xl">
            ...
            <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2, duration: 0.8 }} className="text-5xl font-bold text-gray-900 mb-6 bg-clip-text text-transparent bg-gradient-to-r from-[#36a0d0] to-[#6ec6ab]">
              Get in Touch
            </motion.h1>
            <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4, duration: 0.8 }} className="text-xl text-gray-600 mb-8">
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div ref={ref} initial="hidden" animate={inView ? "visible" : "hidden"} variants={{
            hidden: {},
            visible: {
                transition: {
                    staggerChildren: 0.2,
            ...
            {contactInfo.map((item, index) => (<motion.a key={index} href={item.href} variants={{
                ...
                <div className="relative bg-white/80 backdrop-blur-sm p-8 rounded-xl shadow-lg border border-gray-100 h-full flex flex-col justify-between">
                  ...
                  <div className="relative">
                    <motion.div whileHover={{ rotate: 360 }} transition={{ duration: 0.5 }} className={`w-12 h-12 rounded-full bg-gradient-to-br ${item.gradient} flex items-center justify-center mb-4`}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.8 }} className="rounded-2xl overflow-hidden shadow-2xl">
              <MapComponent />
            </motion.div>
          </div>
        </div>
