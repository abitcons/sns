...
export default function Solutions() {
    ...
    const renderSolutionCards = (solutionData) => solutionData.map((solution, index) => (<SolutionCard key={index} index={index} // Pass the index as required by SolutionCardProps
     title={solution.title} description={solution.description} logo={solution.logo} link={solution.link} features={solution.features}/>));
    return (<>
      {/* SEO Meta Tags */}
      <Helmet>
        <title>Our Solutions - Smart National Solutions</title>
        <meta name="description" content="Explore SNAM solutions suite, including SNAM Travel, SNAM Muqeem, SNAM Yaqeen, innovative AI solutions, and SAP tools to streamline your business operations."/>
    ...
    <div className="space-y-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 flex flex-col items-center text-center transform transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
          ...
          <div className="flex justify-center items-center h-20 w-full mb-5 transform transition-transform duration-300 hover:scale-105">
            <img src="/images/sap-s4hana-logo.png" alt="SAP S/4HANA Logo - Transform Global Operations" className="h-full w-auto object-contain"/>
          </div>
          ...
          <a href="/solutions/erp" className="bg-[#36a0d0] text-white py-2 px-4 rounded text-sm hover:bg-[#5bb6bb] transition-all duration-300 hover:shadow-md group">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 flex flex-col items-center text-center transform transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
          ...
          <div className="flex justify-center items-center h-20 w-full mb-5 transform transition-transform duration-300 hover:scale-105">
            <img src="/images/sap-successfactors-logo.png" alt="SAP SuccessFactors Logo - Redefine Workforce Excellence" className="h-full w-auto object-contain"/>
          </div>
          <p className="text-gray-700 mb-4 text-sm">
          ...
          <a href="/solutions/hr" className="bg-[#36a0d0] text-white py-2 px-4 rounded text-sm hover:bg-[#5bb6bb] transition-all duration-300 hover:shadow-md group">
            <span className="inline-block transform group-hover:translate-x-1 transition-transform duration-200">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 flex flex-col items-center text-center transform transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
          ...
          <div className="flex justify-center items-center h-20 w-full mb-5 transform transition-transform duration-300 hover:scale-105">
            <img src="/images/sap-hybris-logo.png" alt="SAP Hybris Logo - Transform Customer Journeys Globally" className="h-full w-auto object-contain"/>
          </div>
          <p className="text-gray-700 mb-4 text-sm">
          ...
          <a href="/solutions/customer-experience" className="bg-[#36a0d0] text-white py-2 px-4 rounded text-sm hover:bg-[#5bb6bb] transition-all duration-300 hover:shadow-md group">
            <span className="inline-block transform group-hover:translate-x-1 transition-transform duration-200">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 flex flex-col items-center text-center transform transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
          ...
          <div className="flex justify-center items-center h-20 w-full mb-5 transform transition-transform duration-300 hover:scale-105">
            <img src="/images/sap-ariba-logo.png" alt="SAP Ariba Logo - Optimize Global Procurement" className="h-full w-auto object-contain"/>
          </div>
          <p className="text-gray-700 mb-4 text-sm">
          ...
          <a href="/solutions/procurement" className="bg-[#36a0d0] text-white py-2 px-4 rounded text-sm hover:bg-[#5bb6bb] transition-all duration-300 hover:shadow-md group">
            <span className="inline-block transform group-hover:translate-x-1 transition-transform duration-200">
 ...
 {/* AI Solutions Section */}
  ...
  <div className="absolute inset-0">
    ...
    {[...Array(3)].map((_, i) => (<div key={i} className="absolute rounded-full bg-white/10" style={{
                width: '600px',
                height: '600px',
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 justify-center md:max-w-3xl mx-auto">
      {aiSolutions.map((solution, index) => (<div key={index} className="group bg-white rounded-xl p-8 shadow-lg relative overflow-hidden">
          {/* Decorative Top Bar */}
          ...
          <div className="flex justify-center items-center h-20 w-full mb-6 relative">
            ...
            <img src={solution.logo} alt={solution.title} className="h-full w-auto object-contain relative z-10"/>
          </div>
          ...
          <div className="text-left">
            ...
            <ul className="space-y-3 text-gray-600 text-sm mb-6">
              {solution.features.map((feature, featureIndex) => (<li key={featureIndex} className="flex items-center space-x-2 transform transition-all duration-200 hover:translate-x-1">
            ...
            {/* Button */}
            <a href={solution.link} className="inline-flex items-center justify-center w-full bg-[#36a0d0] text-white py-3 px-4 rounded-lg 
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.div ref={snamRef} {...motionProps(snamInView)} className="grid grid-cols-1 lg:grid-cols-3 gap-8">
