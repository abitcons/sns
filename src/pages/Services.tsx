        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            {services.map((service, index) => (
              ...
              >
                <ServiceCard {...service} index={index} isHovered={hoveredCard === index} />
                ...
                {Array.from({ length: totalPages }).map((_, index) => (
                  <button
                    ...
                    className={`w-3 h-3 rounded-full transition-colors ${
                      index === currentPage ? 'bg-[#36a0d0]' : 'bg-gray-300 hover:bg-gray-400'
                    }`}
                  />
                ))}
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <motion.a
              variants={fadeIn}
              href="/contact"
              className="inline-flex items-center justify-center px-8 py-4 text-lg font-medium rounded-full bg-white text-[#36a0d0] hover:bg-opacity-90 transition-colors"
              whileHover={{ scale: 1.05 }}
            >
              Get Started
