...
const NewsCard: React.FC<{ post: NewsPost }> = ({ post }) => {
  return (
    <div className="group h-[480px] bg-white rounded-xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 flex flex-col">
      ...
      <div className="relative h-48 w-full shrink-0">
        ...
        {post.imageUrl ? (
          ...
          <div className="w-full h-full bg-gradient-to-br from-[#36a0d0]/10 to-[#6ec6ab]/10 flex items-center justify-center">
            <span className="text-gray-400">No Image</span>
          </div>
        )}
        {/* Category Badge */}
        {post.category && (
          <div className="absolute top-4 left-4 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full shadow-md z-20">
      ...
      <div className="flex flex-col flex-1 p-6">
        ...
        <div className="mt-auto">
          <Link
            to={`/news/${post.slug}`}
            className="inline-flex items-center justify-center w-full px-4 py-2 bg-gradient-to-r from-[#36a0d0] to-[#6ec6ab] text-white rounded-lg text-sm font-medium shadow-md hover:from-[#2f8bb4] hover:to-[#5ba892] transition-all duration-300"
          >
            Read More
            <svg 
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Stay updated with the latest news, partnerships, and achievements of Smart National Solutions in AI, SAP, and digital transformation in Saudi Arabia."
        />
        <meta
          name="keywords"
          content="SNS news, Smart National Solutions updates, SAP Partner news, digital transformation, AI solutions in KSA, business innovation"
        />
      </Helmet>
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <motion.h1 
              variants={fadeIn} 
              className="text-5xl font-bold mb-6 text-white tracking-tight drop-shadow-lg"
            >
              Latest News & Events
            </motion.h1>
            <motion.p 
