...
const About = () => {
    ...
    return (<>
      ...
      <Helmet>
        ...
        <meta name="description" content="Discover how Smart National Solutions (SNS) leads digital transformation in Saudi Arabia with tailored SAP solutions, innovation, and contributions to Vision 2030."/>
        <meta name="keywords" content="Smart National Solutions, SAP Gold Partner, Saudi Vision 2030, digital transformation, SAP solutions, Riyadh technology company, innovation in KSA"/>
        ...
        <meta property="og:description" content="Learn about Smart National Solutions, our mission, values, and achievements. Discover how we empower businesses in Saudi Arabia with innovative solutions aligned with Vision 2030."/>
        ...
        <meta name="twitter:description" content="Smart National Solutions specializes in cutting-edge SAP solutions and digital transformation, driving Vision 2030 objectives in Saudi Arabia."/>
      ...
      <script type="application/ld+json">
        {JSON.stringify({
            ...
            "@type": "WebPage",
            name: "About Us",
            description: "Discover how Smart National Solutions leads digital transformation in Saudi Arabia with tailored SAP solutions, innovation, and contributions to Vision 2030.",
  ...
  <motion.div initial={{ opacity: 0, y: -50 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }} className="bg-gradient-to-r from-[#36a0d0] via-[#5bb6bb] to-[#6ec6ab] py-12 text-white">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
      <motion.h1 initial={{ scale: 0.9 }} animate={{ scale: 1 }} transition={{ duration: 0.8 }} className="text-5xl font-extrabold mb-4">
        Our Journey
      </motion.h1>
      <motion.p initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.2, duration: 0.8 }} className="text-lg max-w-3xl mx-auto leading-relaxed">
  ...
  <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-16">
    <div className="flex items-center relative">
      {[2010, 2015, 2020, 2023].map((year, index) => (<React.Fragment key={year}>
          {/* Milestone */}
          <motion.div initial={{ opacity: 0, x: -50 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: index * 0.4 }} className="relative flex flex-col items-center text-center mx-4">
            <motion.div whileHover={{ scale: 1.15 }} className="w-32 h-32 bg-white rounded-full shadow-lg flex items-center justify-center mb-6">
              <img src={`/Icons/${year === 2010
                ? "SNS-Icon-Logo"
                : year === 2015
                    ? "SAPGold"
                    : year === 2020
                        ? "SNAM"
                        : "Expansion"}.svg`} alt={`${year}`} className={`${year === 2010 || year === 2015 ? "h-24 w-24" : "h-20 w-20"}`}/>
            </motion.div>
            {/* Year */}
          ...
          {/* Arrow */}
          {index < 3 && (<div className="flex justify-center items-center">
  ...
  <div className="mt-16 py-10 bg-gradient-to-r from-[#36a0d0] via-[#5bb6bb] to-[#6ec6ab] text-center rounded-lg shadow-lg">
    ...
    <a href="/contact" className="inline-block bg-white text-primary font-semibold py-3 px-8 rounded-lg shadow-md hover:bg-gray-100 transition-all duration-300">
      Contact Us Today
    </a>
  </div>
    </section>
 ...
 {/* CEO Message Section */}
  ...
  <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center px-4 sm:px-6 lg:px-8">
    ...
    {/* Image Section */}
    <motion.div initial={{ opacity: 0, x: 50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }} className="order-1 lg:order-2 flex justify-center">
      <img src="/images/CEO.jpg" alt="CEO Abdulmajed Almousa" className="rounded-lg shadow-lg w-full lg:w-[80%] xl:w-[90%] hover:scale-105 transition-transform duration-300"/>
    </motion.div>
  </div>
    </section>
 {/* Team Section */}
 <Team />
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer} className="text-center mb-12">
      <motion.h2 variants={fadeIn} className="text-4xl font-bold text-gray-800 mb-6">
        Our Achievements
      </motion.h2>
      <motion.p variants={fadeIn} className="text-lg text-gray-600 leading-relaxed max-w-3xl mx-auto">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
      {/* Achievement Card 1 */}
      <motion.div whileHover={{ translateY: -10 }} className="bg-white p-8 rounded-xl shadow-md hover:shadow-lg transition-all duration-300 text-center">
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer} className="text-center mb-12">
      ...
      <motion.p variants={fadeIn} className="text-lg leading-relaxed max-w-4xl mx-auto text-white/90">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
      {/* Mission Section */}
      <motion.div variants={fadeIn} whileHover={{ translateY: -10 }} className="bg-white/90 text-gray-800 p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 text-center">
        <img src="/Icons/Mission.gif" alt="Mission Icon" className="h-20 mx-auto mb-4"/>
      ...
      {/* Vision Section */}
      <motion.div variants={fadeIn} whileHover={{ translateY: -10 }} className="bg-white/90 text-gray-800 p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 text-center">
        <img src="/Icons/Vision.gif" alt="Vision Icon" className="h-20 mx-auto mb-4"/>
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    {/* Section Heading */}
    <motion.h2 initial="hidden" whileInView="visible" viewport={{ once: true }} variants={{
            hidden: { opacity: 0, y: 20 },
            visible: { opacity: 1, y: 0, transition: { duration: 0.5 } },
        }} className="text-3xl font-bold text-gray-800 mb-6 text-center">
      Our Core Values
    </motion.h2>
    <motion.p initial="hidden" whileInView="visible" viewport={{ once: true }} variants={{
            hidden: { opacity: 0, y: 20 },
            visible: { opacity: 1, y: 0, transition: { duration: 0.5 } },
    ...
    <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={{
      ...
      {[
        ...
        ].map((value, index) => (<motion.div key={index} variants={{
                hidden: { opacity: 0, y: 20 },
                visible: { opacity: 1, y: 0, transition: { duration: 0.5 } },
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer} className="text-center mb-12">
      <motion.h2 variants={fadeIn} className="text-4xl font-bold text-white mb-6">
        Contributing to Saudi Vision 2030
      </motion.h2>
      <motion.p variants={fadeIn} className="text-lg text-white/90 leading-relaxed max-w-4xl mx-auto">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      {/* Innovation Card */}
      <motion.div variants={fadeIn} whileHover={{ scale: 1.05 }} className="p-8 bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 text-center">
        <div className="h-24 w-24 mx-auto rounded-full overflow-hidden bg-gray-100 flex items-center justify-center">
          <img src="/Icons/Innovation.gif" alt="Innovation" className="h-20 w-20 object-contain"/>
        </div>
      ...
      <motion.div variants={fadeIn} whileHover={{ scale: 1.05 }} className="p-8 bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 text-center">
        <div className="h-24 w-24 mx-auto rounded-full overflow-hidden bg-gray-100 flex items-center justify-center">
          <img src="/Icons/Sustainability.gif" alt="Sustainability" className="h-20 w-20 object-contain"/>
        </div>
      ...
      <motion.div variants={fadeIn} whileHover={{ scale: 1.05 }} className="p-8 bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 text-center">
        <div className="h-24 w-24 mx-auto rounded-full overflow-hidden bg-gray-100 flex items-center justify-center">
          <img src="/Icons/Empowerment.gif" alt="Empowerment" className="h-20 w-20 object-contain"/>
        </div>
      ...
      {[
            {
                ...
                description: "SNS is proud to be an SAP Gold Partner, recognized for our success in implementation and client support.",
            },
            {
                logo: "/Logo/SAP Certified .svg",
                title: "Certified Partner Center of Expertise",
                description: "We are SAP PCOE certified to assist in identifying, building, and managing SAP systems tailored to your needs.",
            },
            {
                logo: "/Logo/ELM.svg",
                title: "Business Applications Partner",
                description: "Strategic partner for ELM, delivering innovative business applications and enterprise solutions.",
                logoSize: "h-20", // Bigger ELM logo
            },
            {
                logo: "",
                title: "50+ Projects Delivered",
                description: "Successfully completed over 50 end-to-end implementations in Saudi Arabia, with 20+ AMS projects.",
            },
        ].map((highlight, index) => (<motion.div key={index} variants={fadeIn} whileHover={{ translateY: -10 }} className="bg-gray-50 p-6 rounded-lg shadow-lg hover:shadow-2xl transition-all duration-300 text-center flex flex-col items-center">
          {highlight.logo ? (<img src={highlight.logo} alt={highlight.title} className={`mx-auto mb-4 object-contain ${highlight.logoSize || "h-16"}`}/>) : (<div className="text-transparent bg-gradient-to-r from-[#36a0d0] to-[#5bb6bb] bg-clip-text text-6xl font-bold mb-4">
              50+
            </div>)}
  ...
  <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center px-6 sm:px-8 lg:px-12">
    ...
    <motion.div initial={{ opacity: 0, x: -50 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }} className="flex justify-center">
      <div className="relative w-full max-w-md lg:max-w-lg">
        <img src="/images/Discover SNS solutions.png" alt="Discover SNS Solutions" className="rounded-lg border border-gray-200 shadow-lg hover:scale-105 transition-transform duration-300"/>
    ...
    <motion.div initial={{ opacity: 0, x: 50 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }} className="text-center lg:text-left">
      ...
      <Link to="/solutions" className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-[#36a0d0] to-[#5bb6bb] text-white rounded-lg font-semibold hover:opacity-90 transition-all duration-300 shadow-lg hover:shadow-xl text-lg">
