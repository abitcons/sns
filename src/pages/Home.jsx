...
export default function Home() {
  const { t, i18n } = useTranslation('Home'); // Initialize translation for the Home namespace

  // Debugging: Ensure the translations are loaded
  console.log('Current Language:', i18n.language);
  console.log('Translation for seo.title:', t('seo.title'));
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              >
                ...
                {/* Hover Indicator */}
                <div className="absolute bottom-0 left-0 right-0 h-1 bg-[#36a0d0] scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left" />
              </motion.div>
            ))}
          </div>
        </div>
