  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Smart National Solutions provides tailored software development services to address your unique business challenges and requirements in Saudi Arabia and the Middle East."
        />
        <meta
          name="keywords"
          content="Custom Software Development, Tailored Software Solutions, Software Development Saudi Arabia, Business Software Solutions, Smart National Solutions"
        />
