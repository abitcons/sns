...
const SoftwareDevelopment = () => {
    return (<>
      <Helmet>
        <title>Custom Software Development Services | Smart National Solutions</title>
        <meta name="description" content="Smart National Solutions provides tailored software development services to address your unique business challenges and requirements in Saudi Arabia and the Middle East."/>
        <meta name="keywords" content="Custom Software Development, Tailored Software Solutions, Software Development Saudi Arabia, Business Software Solutions, Smart National Solutions"/>
      ...
      <section className="relative py-20 bg-gradient-to-r from-primary via-secondary to-accent text-white text-center">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.h1 variants={fadeIn} initial="hidden" animate="visible" className="text-5xl font-bold mb-6">
            Tailored Software Solutions for Your Business
          </motion.h1>
          <motion.p variants={fadeIn} initial="hidden" animate="visible" className="text-lg leading-relaxed">
            Empower your organization with custom software development services designed to meet your unique challenges and requirements.
          </motion.p>
        </div>
      </section>
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }}>
      ...
      <p className="text-lg text-gray-700 mb-12 text-center">
        Smart National Solutions specializes in delivering bespoke software development services to businesses across Saudi Arabia and the Middle East.
      </p>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        {[
            {
                icon: "/Services Icons/Tailored-Solutions.gif",
                title: "Tailored Solutions",
                description: "Software customized to your business requirements for maximum impact.",
            },
            {
                icon: "/Services Icons/Scalable-Development.gif",
                title: "Scalable Development",
                description: "Build robust systems that evolve as your business grows.",
            },
            {
                icon: "/Services Icons/Cutting-Edge-Tech.gif",
                title: "Cutting-Edge Technology",
                description: "Leverage the latest tools and technologies to stay ahead of the competition.",
            },
            {
                icon: "/Services Icons/Expert-Team.gif",
                title: "Experienced Team",
                description: "Work with a team of highly skilled developers with years of expertise.",
            },
        ].map((item, index) => (<motion.div key={index} className="relative group h-full" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: index * 0.2 }}>
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} className="text-center mb-16">
      <h2 className="text-5xl font-bold text-white mb-6">
        Custom Software Development Services by SNS
      </h2>
      <p className="text-lg text-white/90 mb-12 max-w-3xl mx-auto">
        Empower your business with tailored software solutions designed to meet your unique needs and drive innovation across Saudi Arabia and the Middle East.
      </p>
    </motion.div>
      ...
      {[
            {
                ...
                description: 'Build robust systems tailored to your enterprise needs.',
                icon: '/Services Icons/Enterprise-Software.svg',
            },
            {
                title: 'Mobile App Development',
                description: 'Create intuitive and engaging mobile applications.',
                icon: '/Services Icons/Mobile-App.svg',
            },
            {
                title: 'Web Application Development',
                description: 'Design scalable and user-friendly web solutions.',
                icon: '/Services Icons/Web-Development.svg',
            },
            {
                title: 'Software Integration',
                description: 'Seamlessly integrate new software with your existing systems.',
                icon: '/Services Icons/Software-Integration.svg',
            },
            {
                title: 'Maintenance & Support',
                description: 'Ensure optimal performance with dedicated support.',
                icon: '/Services Icons/Maintenance-Support.svg',
            },
            {
                title: 'Custom APIs',
                description: 'Develop APIs for smooth data integration and accessibility.',
                icon: '/Services Icons/Custom-APIs.svg',
            },
        ].map((service, index) => (<motion.div key={index} className="group h-full" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: index * 0.1 }}>
          <div className="bg-white/95 backdrop-blur-sm rounded-xl p-8 shadow-lg hover:shadow-xl transition-all duration-500 group-hover:-translate-y-2 h-full flex flex-col relative overflow-hidden cursor-pointer">
            ...
            <div className="w-16 h-16 bg-white rounded-full shadow-md flex items-center justify-center mb-6 mx-auto group-hover:scale-110 group-hover:rotate-6 transition-all duration-500 relative z-10">
              <img src={service.icon} alt={service.title} className="w-10 h-10 group-hover:scale-110 transition-transform duration-500"/>
            </div>
    ...
    <div className="bg-gradient-to-r from-primary via-secondary to-accent p-1 rounded-2xl relative group">
      ...
      <div className="bg-white rounded-2xl px-8 py-12 relative">
        ...
        <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
          Contact Smart National Solutions to design software tailored to your unique challenges and goals.
        </p>
