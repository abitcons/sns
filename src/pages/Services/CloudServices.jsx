...
const CloudServices = () => {
    return (<>
      <Helmet>
        ...
        <meta name="description" content="Leverage secure and scalable cloud computing solutions from Smart National Solutions to modernize your infrastructure and drive digital innovation across Saudi Arabia and the Middle East."/>
        <meta name="keywords" content="Cloud Computing Services, Scalable Cloud Solutions, Digital Innovation Saudi Arabia, Cloud Modernization, Smart National Solutions"/>
