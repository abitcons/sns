...
const DigitalConsulting = () => {
    return (<>
      <Helmet>
        ...
        <meta name="description" content="Strategic digital transformation consulting services to help organizations embrace technology and transform operations for enhanced efficiency and growth in Saudi Arabia and the Middle East."/>
        <meta name="keywords" content="Digital Transformation Consulting, Business Transformation, Technology Consulting, Saudi Arabia, Middle East, Smart National Solutions"/>
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        ].map((item, index) => (<motion.div key={index} className="relative group" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: index * 0.2 }}>
