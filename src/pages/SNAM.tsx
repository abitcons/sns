...
type FeatureKey = 'ai' | 'travel' | 'muqeem' | 'yaqeen';
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Explore SNAM solutions—SNAM AI, SNAM Travel, SNAM Muqeem, and SNAM Yaqeen—integrated with SAP® SuccessFactors® to transform operations, ensure compliance, and boost productivity."
        />
        <meta
          name="keywords"
          content="SNAM solutions, SAP SuccessFactors integration, HR management, business travel, AI, compliance"
        />
    ...
    >
      ...
      <section className="py-20 bg-gradient-to-r from-gray-100 via-white to-gray-50">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <Link
              to="/contact"
              className="inline-flex items-center bg-[#36a0d0] text-white font-semibold text-xl px-6 py-3 rounded-lg hover:bg-[#36a0d0]/90 transition-all duration-300 group"
            >
      ...
      <section className="py-20 bg-gradient-to-r from-[#36a0d0] via-[#5bb6bb] to-[#6ec6ab] text-white overflow-hidden relative">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center px-4 sm:px-6 lg:px-8">
          ...
          >
            <img
              src="/images/SNAM-AI-Dashboard.png"
              alt="SNAM AI"
