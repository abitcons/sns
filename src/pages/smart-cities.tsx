        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {cityFeatures.map((feature, index) => (
              <div 
                key={index}
                className={`p-6 bg-gray-50 rounded-lg transition-all duration-500 ${
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {cityChallenges.map((item, index) => (
              <div 
                key={index}
                className={`bg-white p-6 rounded-lg shadow-md transition-all duration-500 ${
                  isVisible[`challenge-${index}`] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
                }`}
                id={`challenge-${index}`}
                data-animate
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {citySolutions.map((solution, index) => (
              <div 
                key={index}
                className={`p-6 bg-gray-50 rounded-lg transition-all duration-500 ${
                  isVisible[`solution-${index}`] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
                }`}
                id={`solution-${index}`}
                data-animate
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {implementationSteps.map((step, index) => (
              <div 
                key={index}
                className={`bg-white p-6 rounded-lg shadow-md transition-all duration-500 ${
                  isVisible[`step-${index}`] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
                }`}
                id={`step-${index}`}
                data-animate
              >
