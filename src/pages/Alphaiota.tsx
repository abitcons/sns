...
const InteractiveButton: React.FC<InteractiveButtonProps> = ({ children, href, primary, large }) => (
  <motion.a
    href={href}
    target="_blank"
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              >
                <div
                  className="relative z-10 p-6 rounded-2xl backdrop-blur-sm bg-white/10 border border-white/20 flex flex-col items-center justify-between h-full"
      ...
      <section className="py-20 bg-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 relative">
          ...
          <div className="relative">      
            <motion.div 
              className="hidden md:block absolute top-1/2 left-[10%] right-[10%] z-0"
              initial={{ opacity: 0 }}
            ...
            >
              <motion.div
                ...
                className="h-0.5 bg-gradient-to-r from-[#36a0d0] via-[#5bb6bb] to-[#6ec6ab] transform origin-left"
              />
              ...
              <div className="absolute top-1/2 left-0 right-0 -translate-y-1/2 flex justify-between">
                {[0, 1, 2, 3].map((index) => (
                  <motion.div
                    ...
                    className="w-3 h-3 rounded-full bg-gradient-to-r from-[#36a0d0] to-[#6ec6ab]"
                  />
                ))}
              </div>
            </motion.div>
